 ...
 */
@Entity
@Table(name = "color", schema = "private")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Color.findAll", query = "SELECT c FROM Color c")
    , @NamedQuery(name = "Color.findByCodigo", query = "SELECT c FROM Color c WHERE c.codigo = :codigo")
...
public class Color implements Serializable {
    ...
    public String toString() {
        return "com.intranet.entity.Color[ codigo=" + codigo + " ]";
    }
